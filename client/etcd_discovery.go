...
func NewEtcdDiscovery(basePath string, servicePath string, etcdAddr []string, options *store.Config) client.ServiceDiscovery {
...
func NewEtcdDiscoveryStore(basePath string, kv store.Store) client.ServiceDiscovery {
...
func NewEtcdDiscoveryTemplate(basePath string, etcdAddr []string, options *store.Config) client.ServiceDiscovery {
	if len(basePath) > 1 && strings.HasSuffix(basePath, "/") {
		basePath = basePath[:len(basePath)-1]
	}
...
func (d *EtcdDiscovery) Clone(servicePath string) client.ServiceDiscovery {
